...
const mockHomestays: Homestay[] = [
  ...
  {
    id: "24",
    title: "Homestay gần sân bay Nội Bài",
    location: "Cách 25km",
    distance: "Cách 25km",
